...
<body>
    <header>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarToggler">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?route=medecins">Trouver un professionnel de Sante</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="modal fade" id="forgetPassword" tabindex="-1" role="dialog" aria-labelledby="Title"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form action="/home/forgetPassword" method="post" role="form">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="emailrecup" name="emailrecup"
                                    aria-describedby="emailHelp" placeholder="exemple@email.com">
                                <small id="emailHelp" class="form-text text-muted">Entrez l'adresse email renseignée
                                    lors de votre incription.<br>Vous y recevrez un nouveau mot de passe.</small>
                            </div>
    ...
    <section>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-utilisation"
                            role="tab" aria-controls="v-pills-home" aria-selected="true">Utilisation <i
                                class="fas fa-angle-right"></i></a>
                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-inscription"
                            role="tab" aria-controls="v-pills-profile" aria-selected="false">Inscription <i
                                class="fas fa-angle-right"></i></a>
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-annonces"
                            role="tab" aria-controls="v-pills-messages" aria-selected="false">Annonces <i
                                class="fas fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-9">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-utilisation" role="tabpanel"
                            aria-labelledby="v-pills-utilisation-tab">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p>Cette application a principalement pour objectif de mettre en relation les
                                        utilisateurs de détecteurs de métaux. Cliquez sur une région pour voir les
                                        prospécteurs inscrit, les associations et les annonces.</p>
                                </div>
                            </div>
                        </div>
                        <!-- infos inscription -->
                        <div class="tab-pane fade" id="v-pills-inscription" role="tabpanel"
                            aria-labelledby="v-pills-inscription-tab">
                            <div class="row">
                                <div class="col-sm-3"><img class="float-right" src="/public/img/icon-account.png"></div>
                                <div class="col-sm-9">
                                    <h2 class="h3">Tchat en ligne !</h2>
                                    <p>L'inscription n'est pas obligatoire mais elle permet de contacter les autres
                                        membres via le chat, en message privé !<br>Faites connaissance et organisez vos
                                        sorties détections.</p>
                                </div>
                            </div>
                        </div>
                        <!-- infos annonces -->
                        <div class="tab-pane fade" id="v-pills-annonces" role="tabpanel"
                            aria-labelledby="v-pills-annonces-tab">
                            <div class="row">
                                <div class="col-sm-3"><img class="float-right" src="/public/img/icon-annonce.png"></div>
                                <div class="col-sm-9">
                                    <div class="row d-flex justify-content-between">
                                        <h2 class="h3">la partie annonces !</h2>
                                        <a href="/annonces"><button type="button"
                                                class="btn btn-outline-warning btn-sm">Déposer une annonce</button></a>
                                    </div>
                                    <p>Pour vendre ou trouver votre détecteur de métaux, des accessoires de détection ou
                                        proposer vos services.<br>Le service est gratuit et vous devez être inscrit.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="map__image col-lg-8 p-5">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap"
                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 612 585" width="612"
                        height="585">

                        <g>
                            <a id="FR-GES" xlink:title="Grand Est" xlink:href="/region/index/Grand-Est">
                                <path
                            ...
                            <a id="FR-NAQ" xlink:title="Nouvelle-Aquitaine"
                                xlink:href="/region/index/Nouvelle-Aquitaine">
                                <path
                            ...
                            <a id="FR-ARA" xlink:title="Auvergne-Rhone-Alpes"
                                xlink:href="/region/index/Auvergne-Rhone-Alpes">
                                <path
                            ...
                            <a id="FR-BFC" xlink:title="Bourgogne-Franche-Comte"
                                xlink:href="/region/index/Bourgogne-Franche-Comte">
                                <path
                            ...
                            <a id="FR-BRE" xlink:title="Bretagne" xlink:href="/region/index/Bretagne">
                                <path
                            ...
                            <a id="FR-CVL" xlink:title="Centre-Val de Loire"
                                xlink:href="/region/index/Centre-Val-de-Loire">
                                <path
                            ...
                            <a id="FR-COR" xlink:title="Corse" xlink:href="/region/index/Corse">
                                <path
                            ...
                            <a id="FR-IDF" xlink:title="Ile-de-France" xlink:href="/region/index/Ile-de-France">
                                <path
                            ...
                            <a id="FR-OCC" xlink:title="Occitanie" xlink:href="/region/index/Occitanie">
                                <path
                            ...
                            <a id="FR-HDF" xlink:title="Hauts-de-France" xlink:href="/region/index/Hauts-de-France">
                                <path
                            ...
                            <a id="FR-NOR" xlink:title="Normandie" xlink:href="/region/index/Normandie">
                                <path
                            ...
                            <a id="FR-PDL" xlink:title="Pays de la Loire" xlink:href="/region/index/Pays-de-la-Loire">
                                <path
                            ...
                            <a id="FR-PAC" xlink:title="Provence-Alpes-Cote d'Azur"
                                xlink:href="/region/index/Provence-Alpes-Cote-d'Azur">
                                <path
                ...
                <div class="map__list col-lg-4 d-flex flex-column justify-content-center p-5">
                    <ul class="list-group">
                        <li id="li-GES" class="list-group-item"><a href="/region/index/Grand-Est"
                                id="list-GES">Grand-Est</a></li>
                        ...
                        <li id="li-BRE" class="list-group-item"><a href="/region/index/Bretagne"
                                id="list-BRE">Bretagne</a></li>
                        <li id="li-CVL" class="list-group-item"><a href="/region/index/Centre-Val-de-Loire"
                                id="list-CVL">Centre-Val-de-Loire</a></li>
                        <li id="li-COR" class="list-group-item"><a href="/region/index/Corse" id="list-COR">Corse</a>
                        </li>
                        <li id="li-IDF" class="list-group-item"><a href="/region/index/Ile-de-France"
                                id="list-IDF">Île-de-France</a></li>
                        <li id="li-OCC" class="list-group-item"><a href="/region/index/Occitanie"
                                id="list-OCC">Occitanie</a></li>
                        <li id="li-HDF" class="list-group-item"><a href="/region/index/Hauts-de-France"
                                id="list-HDF">Hauts-de-France</a></li>
                        <li id="li-NOR" class="list-group-item"><a href="/region/index/Normandie"
                                id="list-NOR">Normandie</a></li>
        ...
        <<script src="public/js/medecins.js">
            </script>>
    </section>
    <!-- inclusion du footer -->
    <footer class="mt-5">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="row py-0">
                            ...
                            <div class="col-sm-11">
                                <div>
                                    <p class="ml-3"><span class="header-font">D</span>étection<span
                                            class="header-font">&</span>détecteurs.com</p>
                                    <ul class="ml-3 mb-4">
    ...
    <!--/.footer-->
    <p class="text-center"><small>&copy; 2018 - Tout droits réservés / SIte réalisé par Julien Weck.</small></p>
    <!--/.footer-bottom-->
    <!-- Gestion de la barre de consentement des cookies-->
    <!-- <script src="/js/cookiechoices.js"></script>
<script>
    document.addEventListener('DOMContentLoaded', function(event){
        cookieChoices.showCookieConsentBar('Ce site utilise des cookies pour vous offrir le meilleur service et ils sont importants pour la bon fonctionnement de notre site internet. Afin d\'améliorer votre expérience, nous utilisons des cookies pour conserver les informations de connexion et fournir une connexion sûre (cookies techniques). Cliquez sur "J\'accepte" pour accepter l\'ensemble des cookies et poursuivre directement sur le site ou cliquez sur "Informations" pour consulter en détails les descriptions des types de cookies que vous voulez accepter lorsque vous visitez le site' , 'J’accepte', 'Informations', '/mentions-legales');
    });
</script> -->
    ...
    <script src="public/js/inde.js"></script>
