                            ...
                            <form v-on:submit.prevent="updatePassword" action='/' class="text-center"
                                ...
                                <div class="md-form">
                                    ...
                                    <small id="materialRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4"
                                        v-if="errorCurrentPassword"> {{ errorCurrentPassword }}
                                    </small>
                                </div>
                                ...
                                <div class="md-form">
                                    ...
                                    <input type="password" v-model="newPasswordOne" id="materialRegisterFormEmail"
                                        class="form-control">
                                    <small id="materialRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4"
                                        v-if="errornewPasswordOne"> {{ errornewPasswordOne }}
                                    </small>
                                </div>
        ...
        updatePassword(){
            ...
            .then( response => {
                if (response.data.errors){
                    this.errorCurrentPassword = response.data.errors.errorCurrentPassword;
                    this.errornewPasswordOne = response.data.errors.errornewPasswordOne;
